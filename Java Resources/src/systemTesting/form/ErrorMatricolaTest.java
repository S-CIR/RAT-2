...
public class ErrorMatricolaTest {
	...
	@Test
	public void testErrorMatricola() throws InterruptedException {
	    ...
	    driver.findElement(By.id("matricola")).sendKeys("01234567");
	...
	public  void tearDown () throws InterruptedException {
		...
		assert(messageAlert.equals("Formato non corretto: matricola "));
		driver.quit();
