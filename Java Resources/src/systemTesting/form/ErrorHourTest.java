...
public class ErrorHourTest {
	...
	@Test
	public void testErrorEndDate() throws InterruptedException {
	    ...
	    driver.findElement(By.id("hours")).sendKeys("100");
	...
	public  void tearDown () throws InterruptedException {
		...
		assert(messageAlert.equals("Formato non corretto: hours "));
		driver.quit();
