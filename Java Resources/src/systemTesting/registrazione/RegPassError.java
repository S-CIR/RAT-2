...
public class RegPassError {
	private WebDriver driver;
	  ...
	  @Test
	  public void RegPassErrorTest() throws Exception {
	    ...
	    driver.findElement(By.id("verifica")).sendKeys("password");
	  ...
	  @After
		public void tearDown () {
			...
			assert(messageAlert.equals("Formato non corretto: pass "));
			driver.quit();
		}
