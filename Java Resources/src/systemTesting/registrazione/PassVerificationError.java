...
public class PassVerificationError {
	...
	@Test
	public void PassVerificationErrorTest() throws Exception{
	    ...
	    driver.findElement(By.id("verifica")).sendKeys("Password2");
	...
	public void tearDown () {
		...
		assert(messageAlert.equals("Formato non corretto: verPass "));
		driver.quit();
	}
